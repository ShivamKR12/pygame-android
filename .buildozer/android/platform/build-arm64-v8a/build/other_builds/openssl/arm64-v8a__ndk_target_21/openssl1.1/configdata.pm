...
our %config = (
  ...
  CPPFLAGS => [ "-DANDROID -I/root/.buildozer/android/platform/android-ndk-r25b/toolchains/llvm/prebuilt/linux-x86_64/sysroot/usr/include -I/content/pygame-android/.buildozer/android/platform/build-arm64-v8a/build/python-installs/mypygameapp/arm64-v8a/include/python3.1" ],
  CPPINCLUDES => [  ],
